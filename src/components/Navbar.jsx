...
import logo from '../assets/syd-logo.png'
      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link 
          ...
          onClick={() => {
            ...
            <p className='text-white text-[18px] font-bold cursor-pointer'>Syd</p>
        </Link>
        ...
        <div className='flex justify-end items-center sm:hidden'>
          ...
          <div className={`${!toggle ? "hidden" : 'flex'} p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
            <ul className='flex-col gap-4 flex justify-end items-start'>
              {navLinks.map((link) => (
                <li key={link.id} 
